...
class EssentialTShirtPage extends StatefulWidget {
  const EssentialTShirtPage({super.key});
...
class _EssentialTShirtPageState extends State<EssentialTShirtPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Essential T-Shirt')),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Image.asset(
                'assets/images/tee.png', // Only green allowed
                height: 220,
                fit: BoxFit.contain,
              ),
            ),
            ...
            const Text(
              'Our Essential T-Shirt is a wardrobe staple. Soft, breathable, and available in classic colors.',
              ...
              child: ElevatedButton(
                onPressed: () {
                  Cart().addItem(CartItem(
                    title: 'Essential T-Shirt ($_selectedColour, $_selectedSize)',
                    imageUrl: 'assets/images/tee.png',
                    price: 6.99,
                    quantity: _quantity,
                  ));
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Added $_quantity Essential T-Shirt ($_selectedSize, $_selectedColour) to cart!')),
                  );
                },
