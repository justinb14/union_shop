...
class SignatureTShirtPage extends StatefulWidget {
  const SignatureTShirtPage({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Image.asset(
                'assets/images/tee_navy.png', // Only navy allowed
                height: 220,
                fit: BoxFit.contain,
              ),
            ),
            ...
            const Text(
              'The Signature T-Shirt combines style and comfort. Show off your university spirit with this premium tee.',
              ...
              child: ElevatedButton(
                onPressed: () {
                  Cart().addItem(CartItem(
                    title: 'Signature T-Shirt ($_selectedColour, $_selectedSize)',
                    imageUrl: 'assets/images/tee_navy.png',
                    price: 9.99,
                    quantity: _quantity,
                  ));
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Added $_quantity Signature T-Shirt ($_selectedSize, $_selectedColour) to cart!')),
                  );
                },
